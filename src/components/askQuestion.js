    ...
    <div className="mt-2 p-2">
      <div className="alert my-2 p-4 alert-success">
        <h2 className="text-secondary ">
          Knowledge Share is a plartform for sharing Knowledge and Experience...
        </h2>
        <h4 className="text-info">
          Feel free to ask any question concerning agriculture
        </h4>
        <small>
          The big community of farmers is waiting, Feel free to ask any question
          today?
        </small>
      </div>
      ...
      <div className="my-2">
        <Form>
          <Form.Group className="mb-0 p-4 card" controlId="questionDescription">
          ...
          <Form.Group className="p-4 card mt-2">
            ...
            <br></br>
            <small>Tags are used to classify and search for questions</small>
            <Form.Control
              className="mt-2 mb-3"
              type="text"
